...
function Home() {
  return (
    <Container>
        ...
        <Section title="Lowest Cost Solor Panels in America" description="Money-back guarantee" backgroundImg="solar-panel.jpg" leftBtnText="Order Now" rightBtnText="Learn more"/>
